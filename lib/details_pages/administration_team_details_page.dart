...
Color shapeDecorationColor = Color.fromRGBO(50, 82, 136, 1.0);
Color shapeDecorationColorTwo = Color.fromRGBO(50, 82, 136, 1.0);
Color shapeDecorationTextColor = Color.fromRGBO(50, 82, 136, 1.0);
Color shapeDecorationIconColor = Color.fromRGBO(50, 82, 136, 1.0);
Color cardBackgroundColor = Colors.white;
Color splashColor = Color.fromRGBO(50, 82, 136, 1.0);
Color splashColorTwo = Colors.white;
Color splashColorThree = Color.fromRGBO(50, 82, 136, 1.0);
Color iconTextColor = Colors.white;
Color iconTextColorTwo = Colors.white;
Color buttonColor = Color.fromRGBO(50, 82, 136, 1.0);
Color textColor = Color.fromRGBO(50, 82, 136, 1.0);
...
AdministrationTeamNotifier administrationTeamNotifier;
...
class AdministrationTeamDetailsPage extends StatefulWidget {

  AdministrationTeamDetailsPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _AdministrationTeamDetailsPage createState() => _AdministrationTeamDetailsPage();

}

class _AdministrationTeamDetailsPage extends State<AdministrationTeamDetailsPage>{
  ...
  Widget build(BuildContext context) {
    ...
    administrationTeamNotifier = Provider.of<AdministrationTeamNotifier>(context, listen: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: administrationTeamNotifier.currentAdministrationTeam.image,
                        fit: BoxFit.cover,
                  ...
                  message: administrationTeamNotifier.currentAdministrationTeam.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(administrationTeamNotifier.currentAdministrationTeam.name.toUpperCase(),
  ...
  initState(){
    ...
    _autoBio = administrationTeamNotifier.currentAdministrationTeam.autoBio;
      _bestMoment = administrationTeamNotifier.currentAdministrationTeam.bestMoment;
    _dob = administrationTeamNotifier.currentAdministrationTeam.dob;
    _qualification = administrationTeamNotifier.currentAdministrationTeam.qualification;
    _staffPosition = administrationTeamNotifier.currentAdministrationTeam.staffPosition;
    _yearOfInception = administrationTeamNotifier.currentAdministrationTeam.yearOfInception;
    _regionFrom = administrationTeamNotifier.currentAdministrationTeam.regionOfOrigin;
    _email = administrationTeamNotifier.currentAdministrationTeam.email;
    _facebook = administrationTeamNotifier.currentAdministrationTeam.facebook;
    _linkedIn = administrationTeamNotifier.currentAdministrationTeam.linkedIn;
    _hobbies = administrationTeamNotifier.currentAdministrationTeam.hobbies;
    _instagram = administrationTeamNotifier.currentAdministrationTeam.instagram;
    _name = administrationTeamNotifier.currentAdministrationTeam.name;
    _philosophy = administrationTeamNotifier.currentAdministrationTeam.philosophy;
    _phone = administrationTeamNotifier.currentAdministrationTeam.phone;
    _country = administrationTeamNotifier.currentAdministrationTeam.nationality;
    _twitter = administrationTeamNotifier.currentAdministrationTeam.twitter;
    _snapchat = administrationTeamNotifier.currentAdministrationTeam.snapchat;
    _tikTok = administrationTeamNotifier.currentAdministrationTeam.tikTok;
    _worstMoment = administrationTeamNotifier.currentAdministrationTeam.worstMoment;
