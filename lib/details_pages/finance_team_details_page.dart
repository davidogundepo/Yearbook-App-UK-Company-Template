...
Color backgroundColor = Color.fromRGBO(79, 48, 40, 1.0);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = Color.fromRGBO(79, 48, 40, 1.0);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(79, 48, 40, 1.0);
Color shapeDecorationColorTwo = Color.fromRGBO(79, 48, 40, 1.0);
Color shapeDecorationTextColor = Color.fromRGBO(79, 48, 40, 1.0);
Color shapeDecorationIconColor = Color.fromRGBO(79, 48, 40, 1.0);
...
Color iconTextColorTwo = Color.fromRGBO(79, 48, 40, 1.0);
Color buttonColor = Color.fromRGBO(79, 48, 40, 1.0);
Color textColor = Color.fromRGBO(79, 48, 40, 1.0);
...
FinanceTeamNotifier financeTeamNotifier;
...
class FinanceTeamDetailsPage extends StatefulWidget {
  FinanceTeamDetailsPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _FinanceTeamDetailsPage createState() => _FinanceTeamDetailsPage();
}

class _FinanceTeamDetailsPage extends State<FinanceTeamDetailsPage> {
  ...
  Widget build(BuildContext context) {
    financeTeamNotifier = Provider.of<FinanceTeamNotifier>(context, listen: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: financeTeamNotifier.currentFinanceTeam.image,
                        fit: BoxFit.cover,
                  ...
                  message: financeTeamNotifier.currentFinanceTeam.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              financeTeamNotifier.currentFinanceTeam.name.toUpperCase(),
  ...
  initState() {
    ...
    FinanceTeamNotifier financeTeamNotifier = Provider.of<FinanceTeamNotifier>(context, listen: false);

    _autoBio = financeTeamNotifier.currentFinanceTeam.autoBio;
    _bestMoment = financeTeamNotifier.currentFinanceTeam.bestMoment;
    _dob = financeTeamNotifier.currentFinanceTeam.dob;
    _qualification = financeTeamNotifier.currentFinanceTeam.qualification;
    _staffPosition = financeTeamNotifier.currentFinanceTeam.staffPosition;
    _yearOfInception = financeTeamNotifier.currentFinanceTeam.yearOfInception;
    _regionFrom = financeTeamNotifier.currentFinanceTeam.regionOfOrigin;
    _email = financeTeamNotifier.currentFinanceTeam.email;
    _facebook = financeTeamNotifier.currentFinanceTeam.facebook;
    _linkedIn = financeTeamNotifier.currentFinanceTeam.linkedIn;
    _hobbies = financeTeamNotifier.currentFinanceTeam.hobbies;
    _instagram = financeTeamNotifier.currentFinanceTeam.instagram;
    _name = financeTeamNotifier.currentFinanceTeam.name;
    _philosophy = financeTeamNotifier.currentFinanceTeam.philosophy;
    _phone = financeTeamNotifier.currentFinanceTeam.phone;
    _country = financeTeamNotifier.currentFinanceTeam.nationality;
    _twitter = financeTeamNotifier.currentFinanceTeam.twitter;
    _snapchat = financeTeamNotifier.currentFinanceTeam.snapchat;
    _tikTok = financeTeamNotifier.currentFinanceTeam.tikTok;
    _worstMoment = financeTeamNotifier.currentFinanceTeam.worstMoment;
