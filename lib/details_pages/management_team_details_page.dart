...
Color backgroundColor = Color.fromRGBO(71, 47, 54, 1.0);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = Color.fromRGBO(71, 47, 54, 1.0);
  Color appBarIconColor =  Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(71, 47, 54, 1.0);
Color shapeDecorationColorTwo = Color.fromRGBO(71, 47, 54, 1.0);
Color shapeDecorationTextColor = Color.fromRGBO(71, 47, 54, 1.0);
Color shapeDecorationIconColor = Color.fromRGBO(71, 47, 54, 1.0);
Color cardBackgroundColor =  Colors.white;
Color splashColor = Color.fromRGBO(71, 47, 54, 1.0);
Color splashColorTwo =  Colors.white;
Color splashColorThree = Color.fromRGBO(71, 47, 54, 1.0);
Color iconTextColor =  Colors.white;
Color iconTextColorTwo =  Colors.white;
Color buttonColor = Color.fromRGBO(71, 47, 54, 1.0);
Color textColor = Color.fromRGBO(71, 47, 54, 1.0);
...
ManagementTeamNotifier managementTeamNotifier;
...
class ManagementTeamDetailsPage extends StatefulWidget {

  ManagementTeamDetailsPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ManagementTeamDetailsPage createState() => _ManagementTeamDetailsPage();

}

class _ManagementTeamDetailsPage extends State<ManagementTeamDetailsPage>{
  ...
  Widget build(BuildContext context) {
    ...
    managementTeamNotifier = Provider.of<ManagementTeamNotifier>(context, listen: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: managementTeamNotifier.currentManagementTeam.image,
                        fit: BoxFit.cover,
                  ...
                  message: managementTeamNotifier.currentManagementTeam.name
              ),
              Material(
                ...
                child: InkWell(
                  ...
                  child: Card(
                    ...
                    //       color: cardBackgroundColor.withOpacity(0.20),
                    //       width: 4.0,
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(managementTeamNotifier.currentManagementTeam.name.toUpperCase(),
  ...
  initState(){
    ...
    ManagementTeamNotifier managementTeamNotifier = Provider.of<ManagementTeamNotifier>(context, listen: false);

    _autoBio = managementTeamNotifier.currentManagementTeam.autoBio;
      _bestMoment = managementTeamNotifier.currentManagementTeam.bestMoment;
    _dob = managementTeamNotifier.currentManagementTeam.dob;
    _qualification = managementTeamNotifier.currentManagementTeam.qualification;
    _staffPosition = managementTeamNotifier.currentManagementTeam.staffPosition;
    _yearOfInception = managementTeamNotifier.currentManagementTeam.yearOfInception;
    _regionFrom = managementTeamNotifier.currentManagementTeam.regionOfOrigin;
    _email = managementTeamNotifier.currentManagementTeam.email;
    _facebook = managementTeamNotifier.currentManagementTeam.facebook;
    _linkedIn = managementTeamNotifier.currentManagementTeam.linkedIn;
    _hobbies = managementTeamNotifier.currentManagementTeam.hobbies;
    _instagram = managementTeamNotifier.currentManagementTeam.instagram;
    _name = managementTeamNotifier.currentManagementTeam.name;
    _philosophy = managementTeamNotifier.currentManagementTeam.philosophy;
    _phone = managementTeamNotifier.currentManagementTeam.phone;
    _country = managementTeamNotifier.currentManagementTeam.nationality;
    _twitter = managementTeamNotifier.currentManagementTeam.twitter;
    _snapchat = managementTeamNotifier.currentManagementTeam.snapchat;
    _tikTok = managementTeamNotifier.currentManagementTeam.tikTok;
    _worstMoment = managementTeamNotifier.currentManagementTeam.worstMoment;
