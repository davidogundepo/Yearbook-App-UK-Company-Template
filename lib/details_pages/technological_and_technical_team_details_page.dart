...
Color shapeDecorationColor = Color.fromRGBO(98, 103, 72, 1.0);
Color shapeDecorationColorTwo = Colors.white;
Color shapeDecorationColorThree = Color.fromRGBO(98, 103, 72, 1.0);
Color shapeDecorationTextColor = Color.fromRGBO(98, 103, 72, 1.0);
Color shapeDecorationIconColor = Color.fromRGBO(98, 103, 72, 1.0);
Color cardBackgroundColor = Colors.white;
Color splashColor = Color.fromRGBO(98, 103, 72, 1.0);
Color splashColorTwo = Colors.white;
Color splashColorThree = Color.fromRGBO(98, 103, 72, 1.0);
Color iconTextColor = Colors.white;
Color iconTextColorTwo = Color.fromRGBO(98, 103, 72, 1.0);
Color buttonColor = Color.fromRGBO(98, 103, 72, 1.0);
Color textColor = Color.fromRGBO(98, 103, 72, 1.0);
...
TechnologicalTechnicalTeamNotifier technologicalTechnicalTeamNotifier;
...
class _SubPageState extends State<SubPage> {
  ...
  Widget build(BuildContext context) {
    technologicalTechnicalTeamNotifier = Provider.of<TechnologicalTechnicalTeamNotifier>(context, listen: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.image,
                        fit: BoxFit.cover,
                  ...
                  message: technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.name.toUpperCase(),
  ...
  initState() {
    ...
    _autoBio = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.autoBio;
    _bestMoment = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.bestMoment;
    _dob = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.dob;
    _qualification = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.qualification;
    _staffPosition = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.staffPosition;
    _yearOfInception = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.yearOfInception;
    _regionFrom = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.regionOfOrigin;
    _email = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.email;
    _facebook = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.facebook;
    _linkedIn = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.linkedIn;
    _hobbies = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.hobbies;
    _instagram = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.instagram;
    _name = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.name;
    _philosophy = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.philosophy;
    _phone = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.phone;
    _country = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.nationality;
    _twitter = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.twitter;
    _snapchat = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.snapchat;
    _tikTok = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.tikTok;
    _worstMoment = technologicalTechnicalTeamNotifier.currentTechnologicalTechnicalTeam.worstMoment;
