...
Color shapeDecorationColor = Color.fromRGBO(40, 90, 143, 1.0);
Color shapeDecorationTextColor = Color.fromRGBO(40, 90, 143, 1.0);
Color shapeDecorationColorTwo = Color.fromRGBO(40, 90, 143, 1.0);
Color cardBackgroundColor = Colors.white;
Color splashColor = Colors.white;
Color splashColorTwo = Color.fromRGBO(40, 90, 143, 1.0);
Color splashColorThree = Color.fromRGBO(40, 90, 143, 1.0);
Color iconTextColor = Colors.white;
Color iconTextColorTwo = Color.fromRGBO(40, 90, 143, 1.0);
Color buttonColor = Color.fromRGBO(40, 90, 143, 1.0);
Color textColor = Color.fromRGBO(40, 90, 143, 1.0);
...
MarketingCommercialTeamNotifier marketingCommercialTeamNotifier;
...
class MarketingCommercialTeamDetailsPage extends StatefulWidget {
  MarketingCommercialTeamDetailsPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _MarketingCommercialTeamDetailsPage createState() => _MarketingCommercialTeamDetailsPage();
}

class _MarketingCommercialTeamDetailsPage extends State<MarketingCommercialTeamDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    marketingCommercialTeamNotifier = Provider.of<MarketingCommercialTeamNotifier>(context, listen: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: marketingCommercialTeamNotifier.currentMarketingCommercialTeam.image,
                        fit: BoxFit.cover,
                  ...
                  message: marketingCommercialTeamNotifier.currentMarketingCommercialTeam.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              marketingCommercialTeamNotifier.currentMarketingCommercialTeam.name.toUpperCase(),
  ...
  initState() {
    ...
    _autoBio = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.autoBio;
    _bestMoment = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.bestMoment;
    _dob = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.dob;
    _qualification = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.qualification;
    _staffPosition = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.staffPosition;
    _yearOfInception = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.yearOfInception;
    _regionFrom = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.regionOfOrigin;
    _email = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.email;
    _facebook = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.facebook;
    _linkedIn = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.linkedIn;
    _hobbies = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.hobbies;
    _instagram = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.instagram;
    _name = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.name;
    _philosophy = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.philosophy;
    _phone = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.phone;
    _country = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.nationality;
    _twitter = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.twitter;
    _snapchat = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.snapchat;
    _tikTok = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.tikTok;
    _worstMoment = marketingCommercialTeamNotifier.currentMarketingCommercialTeam.worstMoment;
