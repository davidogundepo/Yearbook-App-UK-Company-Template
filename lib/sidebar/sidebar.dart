...
String subtitle = "We think and practice high-level work ethics.";

String technologicalTechnicalTeamTitle = "Technological and Technical Team";
String digitalDeliveryTeamTitle = "Digital Delivery Team";
String marketingCommercialTeamTitle = "Marketing and Commercial Team";
String financeTeamTitle = "Finance Team";
String administrationTeamTitle = "Administration Team";
String managementTeamTitle = "Management Team";
...
String imgAsset = "assets/images/co_landing_2.jpg";

Color gradientColor = Color.fromRGBO(44, 83, 75, 1.0);
Color gradientColorTwo = Colors.white;
Color linearGradientColor =  Color.fromRGBO(44, 83, 75, 1.0);
Color linearGradientColorTwo =  Color.fromRGBO(44, 83, 75, 1.0);
Color boxShadowColor =  Color.fromRGBO(44, 83, 75, 1.0);
Color dividerColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shimmerBaseColor = Colors.white;
Color shimmerHighlightColor = Colors.white;
Color shapeDecorationTextColor =  Color.fromRGBO(44, 83, 75, 1.0);
Color containerBackgroundColor =  Color.fromRGBO(44, 83, 75, 1.0);
Color containerIconColor = Colors.white;
Color dialogBackgroundColor =  Color.fromRGBO(44, 83, 75, 1.0);
Color dialogTextColor = Colors.white;
Color splashColor = Color.fromRGBO(44, 83, 75, 1.0);
Color splashColorTwo = Colors.white;
Color splashColorThree = Colors.white;
Color textColor = Colors.white;
Color textColorTwo = Color.fromRGBO(44, 83, 75, 1.0);
                            ...
                            Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _onSelected(0);
                                  onIconPressed();
                                  BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.myTechnologicalTechnicalTeamPageClickedEvent);
                                },
                                child: Align(
                            ...
                            Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _onSelected(1);
                                  onIconPressed();
                                  BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.myDigitalDeliveryTeamPageClickedEvent);
                                },
                                child: Align(
                                  alignment: Alignment.centerLeft,
                                  child: MenuItems(
                            ...
                            Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _onSelected(2);
                                  onIconPressed();
                                  BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.myMarketingCommercialTeamPageClickedEvent);
                                },
                                child: Align(
                                  alignment: Alignment.centerLeft,
                                  child: MenuItems(
                            ...
                            Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _onSelected(3);
                                  onIconPressed();
                                  BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.myFinanceTeamPageClickedEvent);
                                },
                                child: Align(
                                  alignment: Alignment.centerLeft,
                                  child: MenuItems(
                            ...
                            Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _onSelected(4);
                                  onIconPressed();
                                  BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.myAdministrationTeamPageClickedEvent);
                                },
                                child: Align(
                                  alignment: Alignment.centerLeft,
                                  child: MenuItems(
                            ...
                            Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _onSelected(5);
                                  onIconPressed();
                                  BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.myManagementTeamPageClickedEvent);
                                },
                                child: Align(
                                  alignment: Alignment.centerLeft,
                                  child: MenuItems(
