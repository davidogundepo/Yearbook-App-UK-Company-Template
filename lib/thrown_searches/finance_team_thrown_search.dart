...
class MyFinanceTeamSearch extends SearchDelegate {

  final List all;

  MyFinanceTeamSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((financeTeam) => financeTeam.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((financeTeam) => financeTeam.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          financeTeamNotifier.currentFinanceTeam = search[position];
