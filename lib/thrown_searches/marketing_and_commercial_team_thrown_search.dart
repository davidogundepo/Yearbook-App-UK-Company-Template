...
class MyMarketingCommercialTeamSearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MyMarketingCommercialTeamSearch({@required this.all});
  ...
  Future navigateToMarketingCommercialTeamDetailsPage(context) async {
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((marketingCommercialTeam) => marketingCommercialTeam.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((marketingCommercialTeam) => marketingCommercialTeam.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          marketingCommercialTeamNotifier.currentMarketingCommercialTeam = search[position];
                          navigateToMarketingCommercialTeamDetailsPage(context);
                        },
